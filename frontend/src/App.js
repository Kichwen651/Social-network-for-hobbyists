...
import GroupPage from './pages/GroupPage'; // GroupPage component (with dynamic group route)
      ...
      <Router>
        ...
        <div className="container mt-4">
          ...
          <Routes>
            ...
            {/* Dynamic Group Route */}
            <Route path="/group/:hobbyName" element={<PrivateRoute><GroupPage /></PrivateRoute>} />
